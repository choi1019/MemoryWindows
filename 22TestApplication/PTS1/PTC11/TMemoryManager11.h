...
public:
	...
	virtual void Initialize() {
		...
		Exception::s_pMemory = new("Exception::s_pMemoryEven") PMemoryEven(sizeof(Exception), PTC11_COUNT_EXCEPTION);
		Exception::s_pMemory->Initialize();
		this->Add((Memory*)Exception::s_pMemory);

		Log::s_pMemory = new("Log::s_pMemoryEven") PMemoryEven(sizeof(Log), PTC11_COUNT_LOG);
