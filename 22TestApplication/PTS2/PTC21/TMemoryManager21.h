...
#include "Config.h"
#define _TMemoryManager21_Id _GET_TESTCASE_UID(_ELayer_PTS2::_eTMemroyManager21)
#define _TMemoryManager21_Name "TMemoryManager"

#include "../../../13PTechnical/PMemoryManager/PMemoryManager.h"


class TMemoryManager21 : public PMemoryManager {

public:
	static size_t getMemorySize() {
		int szTotalMemory1 = sizeof(PMemoryManager) + sizeof(size_t);
		int szTotalMemory2 = sizeof(PMemoryVariable) + PTC21_SIZE_MEMORYBASE + 2 * sizeof(size_t);
		int szTotalMemory3 = sizeof(PMemoryEven) + PTC21_COUNT_EXCEPTION * sizeof(Exception) + 2 * sizeof(size_t);
		int szTotalMemory4 = sizeof(PMemoryEven) + PTC21_COUNT_LOG * sizeof(Log) + 2 * sizeof(size_t);
		//			int szTotalMemory5 = sizeof(PMemoryEven) + PTC21_COUNT_EVENT * sizeof(Event) + 2 * sizeof(size_t);
	...
	TMemoryManager21(
		...
		int nClassid = _TMemoryManager21_Id,
		const char* pcClassName = _TMemoryManager21_Name)
		: PMemoryManager(
			szTotalMemory,
			nClassid, pcClassName) {

	}
	virtual ~TMemoryManager21() {}


	virtual void Initialize() {
		MemoryManager::Initialize();

		BaseObject::s_pMemory = new("BaseObject::s_pMemory") PMemoryVariable(PTC21_SIZE_MEMORYBASE);
