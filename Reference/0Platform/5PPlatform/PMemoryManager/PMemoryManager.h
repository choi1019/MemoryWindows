...
#include "../typedef.h"
#define _PMemoryManager_Id _GET_CLASS_UID(_EPPlatform::_ePMemoryManager)
#define _PMemoryManager_Name "PMemoryManager"

#include "../../3Technical/MemoryManager/MemoryManager.h"
...
public:
	...
	virtual size_t Show(const char* pMessage) {
		...
		size_t szSum = szMemoryBase + szMemoryException + szMemoryLog + szMemoryEvent;
